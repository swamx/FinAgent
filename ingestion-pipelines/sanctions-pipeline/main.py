...
from config import REDIS_HOST, REDIS_PORT, BATCH_SIZE, DATASET_URL
from sanctionsParser import parse_entity, stream_entities
from redisWriter import RedisWriter

redis_writer = RedisWriter(REDIS_HOST, REDIS_PORT)
...
print(f"Ingesting {data_file} → RedisGraph graph 'entities'")
